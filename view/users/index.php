...
<body>
    <div class="container d-flex justify-content-center">
        ...
        <div class="modal-dialog" role="document">
            <!-- Formulaire -->
            <form class="modal-content" method="POST" action="users/add">
        ...
        <?php
            foreach($users as $user) {
                ?> <div class="card col-12 col-md-6 col-lg-3">
                    <!-- Image du contact -->
                    <img class="card-img-top" style="max-height: 180px" src="<?php echo $user->getPhoto();?>" alt="<?php echo 'photo de '.$user->getNom();?>">
                    <div class="card-body">
                        <!-- Nom + Prenom du contact -->
                        <h5 class="card-title"><?php echo $user->getNom().' '.$user->getPrenom()?></h5>
                        <!-- Résumé de la description du contact (max: 150 caractères) -->
                        <p class="card-text"><?php echo strlen($user->getDescription()) > 150 ? substr($user->getDescription(), 0, 150)."..." : $user->getDescription();?></p>
                    </div>
                </div> <?php
            }
        ?>
